...
1. Installieren Sie Java 17.
```
    pacman -S openjdk17-src jre17-openjdk
```
1. Setzen Sie diese Java Version als Standard.
```
    archlinux-java set java-17-openjdk
```
1. Prüfen Sie die Java Installation.
```
    java --version
```
1.Wenn die Ausgabe in etwa so aussieht, ist die Installation erfolgreich.
Achten Sie insbesondere darauf, dass es Java 17 ist.
```
