...
1. Laden Sie sich <ins> <a href="https://www.jetbrains.com/de-de/toolbox-app/" target="_blank">hier</a></ins> die Toolbox von JetBrains herunter. 
...
4. Sie können entweder die Community Edition oder die Ultimate Edition von IntelliJ installieren. Mit beiden Versionen können die Hausübung bearbeiten.
   * Die Ultimate Edition bittet Ihnen einige weiter Features und Sie erhalten sie als Student kostenlos. Dafür müssen Sie sich <ins> <a href=" https://www.jetbrains.com/de-de/community/education/#students" target="_blank">hier</a></ins> mit Ihrer studentischen E-Mail registrieren und danach in der Toolbox rechts oben auf das Zahnrad drücken und dann auf **"Log in"** gehen.
