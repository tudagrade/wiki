...
* Sie können entweder die Community Edition oder die Ultimate Edition von IntelliJ installieren. Mit beiden Versionen können die Hausübung bearbeiten.
...
Fall Sie einen [AUR-Helper](https://wiki.archlinux.org/title/AUR_helpers)
installiert haben, könnnen Sie das Paket
[`intellij-idea-ce`](https://aur.archlinux.org/packages/intellij-idea-ce),
bzw. [`intellij-idea-ultimate-edition`](https://aur.archlinux.org/packages/intellij-idea-ultimate-edition),
installieren.
...
1. Installieren Sie die Abhängigkeiten.
    ...
    * Für die Ultimate Edition klonen Sie:
        ...
        ```
1. Wechseln Sie in das jeweilige Verzeichnis und installieren Sie das Paket.
    ```
    cd intellij-idea-* && makepgk -ifs
    ```
1. Nun können Sie die Hausübung mit IntelliJ bearbeiten. Befolgen Sie dafür die Schritte der Anleitungen im Abschnitt **"Hausübung"**.
    ...
    * Starten Sie die Ultimate Edition,
    werden Sie beim ersten mal aufgefordert,
    sich mit Ihrem studentischen Account anzumelden.
...
1. Führen Sie den heruntergeladenen Installer aus und drücken Sie auf **"installieren"**. 
1. Wählen Sie **"JetBrains Toolbox ausführen"** aus und drücken Sie zum Schluss auf **"Fertigstellen"**, um den Installationsprozess abzuschließen.
1. Es öffnet sich automatisch die Toolbox. Drücken Sie nun auf **"Continue"**, akzeptieren Sie die Nutzungsbedingungen und drücken Sie zum Schluss auf **"Get started"**. 
...
1. Laden Sie sich <ins> <a href="https://www.jetbrains.com/de-de/toolbox-app/" target="_blank"><span style="color:#349eeb">hier</span></a></ins> die Toolbox von JetBrains herunter.
1. Öffnen Sie die heruntergeladene .dmg Datei und verschieben Sie die Toolbox per Drag&Drop in den Applications Ordner oder auf den Desktop. Nun können Sie die .dmg Datei wieder schließen und auswerfen.
1. Starten Sie nun die Toolbox. Drücken Sie nun auf **"Continue"**, akzeptieren Sie die Nutzungsbedingungen und drücken Sie zum Schluss auf **"Get started"**. 
1. Nun können Sie die Hausübung mit IntelliJ bearbeiten. Befolgen Sie dafür die Schritte der Anleitungen im Abschnitt **"Hausübung"**.
    * Wenn Sie IntelliJ das erste Mal starten werden Sie möglicherweise noch gefragt, ob Sie Einstellungen importieren möchten. Dies benötigen Sie nicht.
