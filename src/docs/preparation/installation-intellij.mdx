...
* <span style="color:red">Beachten Sie, dass Eclipse von uns nicht mehr unterstützt wird und wir Ihnen nicht garantieren können, dass das Bearbeiten der Hausübungen mit anderen IDEs als IntelliJ funktioniert.</span>
