...
* Falls Sie weiterhin Probleme beim Exportieren haben, schauen Sie sich die Fehlermeldung in der Konsole, welche sich beim Ausführen der des Programmes oder einer Gradle Task automatisch öffnet, an. Anbei finden Sie ein paar mögliche Fehler:  
