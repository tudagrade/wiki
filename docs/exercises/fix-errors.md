...
=== "Technische Fehler"
    ...
    * Anbei finden Sie ein paar mögliche Fehler, welche Ihnen in der Konsole, die sich beim Ausführen der des Programmes oder einer Gradle Task automatisch öffnet, angezeigt werden. Damit Ihnen die vollständigen Fehlermeldungen angezeigt werden, wählen Sie links von der Konsole die zweite Option von oben aus.
    ...
    10. !!! error ""
        ...
        ```
        Dieser Fehler kann manchmal beim Ausführen der Public Tests auftreten. Versuchen Sie zunächst im IntelliJ Terminal, welches sich am linken unteren Rand öffnen lässt, den Befehl "**./gradlew --stop**" auszuführen und danach die Public Tests erneut auszuführen. Alternativ können Sie auch IntelliJ neustarten. Falls der Fehler weiterhin auftritt, versuchen Sie [Java mehr Speicher zuzuweisen].
